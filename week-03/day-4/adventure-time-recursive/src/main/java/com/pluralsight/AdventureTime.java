...
{
    static HashMap<Integer, Step> adventureSteps;
    ...
    public static HashMap<Integer, Step> loadAdventure()
    {
        ...
        try {
            ...
            while (line != null)
            {
                ...
                Step step = new Step(id, text, option1Text, option1NextId, option2Text, option2NextId);
